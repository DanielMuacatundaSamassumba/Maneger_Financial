      ...
      <div className='flex flex-col items-center justify-center'>
        ...
        <div className='w-full'>
          <form className='w-full flex flex-col justify-center items-center mt-4' onSubmit={handleSubmit(Onsumbit)}>
            ...
            <input type="email"
              className='w-11/12 p-3 bg-main_color  outline-none mt-2 ' style={{ border: "1px solid #847D7D" }} placeholder='Email' {...register("email")} required />
            <p className='w-11/12 mt-2'>{errors.email?.message ? <div className=' text-red-500'><p className='w-full'>* Apenas Número de telefone</p></div> : ""}</p>

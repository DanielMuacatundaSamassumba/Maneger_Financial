...
export default function
    () {
    return (
        <div className='flex flex-col justify-between items-center  h-2/3 mt-3'>
            <div className='text-white bg-main_color flex flex-col justify-center items-center w-11/12 p-3'>
            ...
            <div className='text-white bg-main_color flex flex-col justify-center items-center w-11/12 p-3 mt-3'>
